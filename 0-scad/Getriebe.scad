...
// stirnrad (modul=1, zahnzahl=36, breite=5, bohrung=4, eingriffswinkel=20, schraegungswinkel=0, optimiert=true);
...
// hohlrad (modul=1, zahnzahl=30, breite=5, randbreite=3, eingriffswinkel=20, schraegungswinkel=0);
